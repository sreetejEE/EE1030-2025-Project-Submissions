...
image_load = 'test_image.png' #defines image_path for test_image , can be replaced it with our requirements
k=20 #defines integer k , can be replaced as per our requirements
